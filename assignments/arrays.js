...
console.log(`The last car in the list is ${lastCar}.`);
...
// let carModels = inventory.map(inventory => inventory.car_model);
let carModels = inventory.map(function(inventory){
